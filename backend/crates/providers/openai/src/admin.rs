...
impl ProviderAdmin for OpenAiAdminProvider {
    ...
    async fn continuous_ticket(
        &self,
        input: gateway_admin::model::tickets::TicketContinuousInput,
    ) -> Result<gateway_admin::model::tickets::TicketPanel, ProviderAdminError> {
        self.tickets
            .as_ref()
            .ok_or_else(|| provider_admin_error(ProviderAdminErrorKind::Unsupported))?
    ...
    async fn ticket_exit_sample(
        &self,
        input: gateway_admin::model::tickets::TicketExitProbe,
    ) -> Result<gateway_admin::model::tickets::TicketExitSample, ProviderAdminError> {
        self.tickets
            .as_ref()
            .ok_or_else(|| provider_admin_error(ProviderAdminErrorKind::Unsupported))?
            .sample_exit(input)
